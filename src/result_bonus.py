...
if __name__ == "__main__":
    ...
    for idx, bonus in enumerate(bonuses):
        ...
        timesteps, mean_reward, ci_reward, mean_length, ci_length, mean_energy, ci_energy, ref_reward, ref_length, ref_energy = get_data(seeds, bonus = bonus)
